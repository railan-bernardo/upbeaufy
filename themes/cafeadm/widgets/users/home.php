...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <form action="<?= url("/admin/users/home"); ?>" class="app_search_form">
            <input type="text" name="s" value="<?= $search; ?>" placeholder="Search users:">
        ...
        <section>
            <div class="app_users_home">
                <?php foreach ($users as $user):
                    $userPhoto = ($user->photo() ? url("/storage/".$user->photo) :
                ...
                <article class="user radius">
                    ...
                    <div class="actions">
                        <a class="icon-cog btn btn-blue" href="<?= url("/admin/users/user/{$user->id}"); ?>" title="">To
                            manage</a>
                    </div>
                </article>
                <?php endforeach; ?>
