...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        <h2 class="">Lista de Orçamentos</h2>
    </header>
    ...
    <?php if(!$posts): ?>
        <div class="message info icon-info">Nemhum orçamento até o momento.</div>
                <?php else: ?>
                <table>
                    <thead>
                    <tr>
                    ...
                    <?php foreach ($posts as $contact):?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= url("/admin/orcamento/post/{$contact->id}"); ?>" class="btn btn-blue" style="margin-right: 5px;">Ver Mais</a>
                                <a href="#" class="remove_link"
                                   data-post="<?= url("/admin/orcamento/post/{$contact->id}"); ?>"
                                   data-action="delete"
